...
namespace SvnBridge.Presenters
{
	public class ListenerViewPresenter
	{
		...
		public void StartListener()
        {
            ...
            SAWCommon.LoadIni();
            PathParserSingleServerWithProjectInPath parser = new PathParserSingleServerWithProjectInPath(SAWCommon.SourceControlBridgeServer);
#else
            PathParserSingleServerWithProjectInPath parser = new PathParserServerAndProjectInPath(Container.Resolve<TfsUrlValidator>());
#endif
            listener.Port = SAWCommon.SourceControlBridgePort;
